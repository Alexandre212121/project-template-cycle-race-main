...
function preload(){
  ...
  racerground= loadAnimation("./mainPlayer3.png");
  
  oppPink1Img = loadAnimation("./op1.png","./op2.png");
  oppPink2Img = loadAnimation("./op3.png");
  
  oppYellow1Img = loadAnimation("./op4.png","./op5.png");
  oppYellow2Img = loadAnimation("./op6.png");
  
  oppRed1Img = loadAnimation("./op7.png","./op8.png");
  oppRed2Img = loadAnimation("./op9.png");
  
  cycleBell = loadSound("./bicyclesound.mp3");
...
mainCyclist.setCollider("circle", 200, 200, 200)
